...
# PR-based release script for static-hosting-mcp.
#
...
#      triggers .github/workflows/publish.yml (the OIDC PyPI publish).
#
# Flags:
...
Once this merges, \`${TAG}\` is tagged to trigger the PyPI publish workflow.
